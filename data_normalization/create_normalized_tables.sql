-- Create normalized tables for all entities with correct column names
...
SELECT 
    ...
    d.model_number AS model,
    d.firmware_version,
    d.installed_at AS installation_date,
    d.last_maintenance_at AS last_maintenance_date,
...
SELECT 
    ...
    f.feature_created_at AS release_date,
    f.adoption_rate,
    f.active_users,
