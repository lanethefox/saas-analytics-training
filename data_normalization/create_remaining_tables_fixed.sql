-- Create remaining normalized tables with verified column names
-- Non-destructive approach - only creates if not exists
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables 
        ...
        SELECT 
            ...
            u.last_active_date AS last_login,
            u.engagement_score,
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM information_schema.tables 
        ...
        SELECT 
            ...
            COALESCE(l.zip_code, '00000') AS postal_code,
            l.timezone,
