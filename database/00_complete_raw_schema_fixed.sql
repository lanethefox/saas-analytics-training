-- =====================================================
-- SaaS Data Platform - FIXED Raw Schema Definition
-- =====================================================
-- Creates all tables with proper source_table naming to match dbt sources
-- Columns match our synthetic data generation output
...
-- Companies/Accounts (from companies.json)
...
-- Device Events/Tap Events (from devices/events_batch_*.json)
...
-- User Sessions (from user_sessions.json)
...
-- Page Views (from page_views.json)
...
-- Feature Usage (placeholder - file not generated yet)
...
-- Stripe Customers (from stripe/customers.json)
...
-- Stripe Prices (from stripe/prices.json)
...
-- Stripe Subscriptions (from stripe/subscriptions.json)
...
-- Stripe Subscription Items (from stripe/subscription_items.json)
...
-- Stripe Invoices (from stripe/invoices.json)
...
-- Stripe Charges (from stripe/charges.json)
...
-- Stripe Payment Intents (from stripe/payment_intents.json)
...
-- Stripe Events (from stripe/events.json)
...
-- HubSpot Companies (from hubspot/companies.json)
...
-- HubSpot Contacts (from hubspot/contacts.json)
...
-- HubSpot Deals (from hubspot/deals.json)
...
-- HubSpot Engagements (from hubspot/engagements.json)
...
-- HubSpot Owners (from hubspot/owners.json)
...
-- HubSpot Tickets (from hubspot/tickets.json)
...
-- Attribution Touchpoints (from marketing/attribution_touchpoints.json)
...
-- Google Ads Campaigns (from marketing/google_ads_campaigns.json)
...
-- Facebook/Meta Ads Campaigns (from marketing/facebook_ads_campaigns.json)
...
-- LinkedIn Ads Campaigns (from marketing/linkedin_ads_campaigns.json)
...
-- Iterable Email Campaigns (from marketing/iterable_campaigns.json)
...
-- Google Analytics Sessions (from marketing/google_analytics_sessions.json)
...
-- Marketing Qualified Leads (from marketing/marketing_qualified_leads.json)
...
COMMENT ON SCHEMA raw IS 'Raw data layer for all source systems - matches synthetic data generation output';

-- App Database Comments
COMMENT ON TABLE raw.app_database_accounts IS 'Customer companies from companies.json - main business entities';
COMMENT ON TABLE raw.app_database_locations IS 'Physical business locations from locations.json';
COMMENT ON TABLE raw.app_database_users IS 'Individual platform users from users.json';
COMMENT ON TABLE raw.app_database_devices IS 'IoT devices deployed at locations from devices.json';
COMMENT ON TABLE raw.app_database_subscriptions IS 'Subscription plans from subscriptions.json';
COMMENT ON TABLE raw.app_database_tap_events IS 'Real-time device events from devices/events_batch_*.json';
COMMENT ON TABLE raw.app_database_user_sessions IS 'User login sessions from user_sessions.json';
COMMENT ON TABLE raw.app_database_page_views IS 'Web app page views from page_views.json';

-- HubSpot Comments
COMMENT ON TABLE raw.hubspot_companies IS 'HubSpot CRM companies from hubspot/companies.json';
COMMENT ON TABLE raw.hubspot_contacts IS 'HubSpot CRM contacts from hubspot/contacts.json';
COMMENT ON TABLE raw.hubspot_deals IS 'HubSpot sales deals from hubspot/deals.json';

-- Marketing Comments
COMMENT ON TABLE raw.attribution_touchpoints IS 'Marketing attribution touchpoints from marketing/attribution_touchpoints.json';
COMMENT ON TABLE raw.google_ads_campaigns IS 'Google Ads performance from marketing/google_ads_campaigns.json';
COMMENT ON TABLE raw.marketing_qualified_leads IS 'MQLs from marketing/marketing_qualified_leads.json';